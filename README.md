...
<table align="center" style="border-collapse: collapse; text-align: left;">
  ...
  <tr>
    ...
    <td style="padding: 10px;">VTU College, Belagavi <br>(Google Developer Group)</td>
    <td style="padding: 10px;">Rohan Halaj, Ashish Bevinakatti,<br> Nayana Barki, Mohammed Adil</td>
  </tr>
  <tr>
    <td style="padding: 10px; font-size: 1.2em;">🥇 1st Place</td>
    <td style="padding: 10px;"><b>HackAura 2026</b> <br><i>11–14 March 2026</i></td>
    <td style="padding: 10px;">GIT Belagavi</td>
    <td style="padding: 10px;">Rohan Halaj, Ashish Bevinakatti,<br> Nayana Barki, Mohammed Adil</td>
  </tr>
  <tr>
    <td style="padding: 10px; font-size: 1.2em;">🥈 2nd Place</td>
    <td style="padding: 10px;"><b>Mini Hackathon</b> <br><i>11–12 April 2026</i></td>
    <td style="padding: 10px;">KLE Technological University, Belagavi <br>(ITS IEEE)</td>
    <td style="padding: 10px;">Rohan Halaj, Ashish Bevinakatti,<br> Nayana Barki, Mohammed Adil</td>
  </tr>
  <tr>
    <td style="padding: 10px; font-size: 1.2em;">🥈 2nd Place</td>
    <td style="padding: 10px;"><b>Nexora</b> <br><i>11 Oct 2025</i></td>
    <td style="padding: 10px;">Jain College of Engineering, Belagavi</td>
    <td style="padding: 10px;">Rohan Halaj, Ashish Bevinakatti,<br> Mohammed Adil, Saish Pauskar</td>
  </tr>
</table>
...
<details>
  ...
  <p align="center">
    ...
    <img src="https://skillicons.dev/icons?i=js,ts,python,java,c,cpp&perline=8" /><br><br>
    <b>Frontend & Backend:</b><br>
    <img src="https://skillicons.dev/icons?i=react,nextjs,nodejs,express&perline=8" /><br><br>
    <b>Infrastructure & Storage:</b><br>
    <img src="https://skillicons.dev/icons?i=mongodb,postgres,docker,aws,linux,git&perline=8" /><br>
  </p>
</details>
